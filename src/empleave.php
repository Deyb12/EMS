		   ...
		   <tr class= "tbl">
			...
			<?php
				...
				//echo "difference " . $interval->days . " days ";
					...
					echo "<td><a href=\"approve.php?id=$employee[id]&token=$employee[token]\"  onClick=\"return confirm('Are you sure to APPROVE the request?')\">&#x2611</a> | <a href=\"cancel.php?id=$employee[id]&token=$employee[token]\" onClick=\"return confirm('Are you sure to CANCEL the request?')\">&#x2612</a></td>";
