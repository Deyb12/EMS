...
<body>
	...
	<body class="hero-anime">
		...
		<div class="p-t-20">
			<button class="btn btn--radius btn--green" type="submit" style="float: right; margin-right: 11.8rem;"><a href="reset.php" style="text-decoration: none; color: white; "> Reset Points</button>
		</div>
